...
unsafe public class SimpleProceduralMesh : MonoBehaviour {

    [DllImport("meshinator")]
    unsafe private static extern void updateMesh(void *_vertex_positions, int num_vertices);

    [DllImport("meshinator")]
    unsafe private static extern void logMesh(void *_vertex_positions, int num_vertices);
    ...
    void Update() {
        ...
        updateMesh(NativeArrayUnsafeUtility.GetUnsafePtr(meshData.GetVertexData<float3>(0)), vertexCount);
