...
unsafe public class snake_OLD : MonoBehaviour {

    [DllImport("meshinator")]
    unsafe private static extern void passSnakeMesh(void *vertex_positions, void *triangle_indices, void *vertex_normals);

    [DllImport("meshinator")]
    unsafe private static extern int num_verts_snake();

    [DllImport("meshinator")]
    unsafe private static extern int num_triangles_snake();
    ...
    void Update () {
        ...
        int vertexCount = num_verts_snake();
        int triangleIndexCount = num_triangles_snake() * 3;
